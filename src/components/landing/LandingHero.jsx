...
export default function LandingHero({ headline, subheadline, bullets, badge, service }) {
  return (
    <section className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden pb-20" style={{paddingTop: '140px', marginTop: '80px'}}>
      {/* Background accent */}
