...
export default function News() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead 
        title="Merchant Services & Payment Processing News | EzPay America Blog"
        description="Expert articles on credit card processing, cash discount programs, POS systems, merchant services, and small business payment tips. Stay ahead with EzPay America's payment industry insights."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredArticles.map((article, index) => (
              ...
              >
                <Link 
                  to={article.slug ? `/news/${article.slug}` : article.id ? `/news/${article.id}` : "#"}
