  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead 
        ...
        description="Leading merchant services and credit card processing with zero transaction fees. Free POS systems for retail stores and restaurants. No monthly fees, no contracts, 24/7 support. Call (865) 316-9625 today."
