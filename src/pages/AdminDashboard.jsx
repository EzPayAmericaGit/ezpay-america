    ...
    <div className="min-h-screen bg-gray-50 py-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-8">
          ...
          <Link to={createPageUrl("BusinessScraper")}>
            <Card className="hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-l-indigo-500">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-gray-900">Lead Scraper</h3>
                <p className="text-sm text-gray-500">Extract business info</p>
              </CardContent>
            </Card>
          </Link>
        </div>
